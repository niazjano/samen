        ...
        <div className="prose prose-neutral mx-auto max-w-3xl dark:prose-invert">
          <FadeIn>
            <div className="space-y-8 text-muted-foreground leading-relaxed">
              <p>Masjid Hayat värnar om din integritet. Denna policy beskriver hur vi hanterar personuppgifter i enlighet med GDPR.</p>
              <section><h2 className="text-xl font-semibold text-foreground">Personuppgiftsansvarig</h2><p className="mt-2">Masjid Hayat, {siteConfig.address}. Kontakt: {siteConfig.email}</p></section>
